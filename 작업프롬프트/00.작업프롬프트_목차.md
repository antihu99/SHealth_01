...
| **3** | 1h | UnitTest 작성 | [`3단계_PCTF.md`](./3단계_PCTF.md) | `src/test/java/com/bestreviewer/*`, `Report/03.S_Health_단위테스트_보고서.md` |
| **3-2** | (3단계 내) | 결함·권장사항 통합 | [`3-2단계_PCTF.md`](./3-2단계_PCTF.md) | `docs/03-2.S_Health_결함_레지스터.md`, `docs/03-2.S_Health_권장사항_레지스터.md`, `Report/03-2.*` |
| **4** | 2h | 기능 개선 (SRP·신규 API) | [`4단계_PCTF.md`](./4단계_PCTF.md) | 분리된 도메인 클래스·신규 TC |
| **4-2** | (4단계 내) | 신규 기능 2차 리팩토링 | [`4-2단계_PCTF.md`](./4-2단계_PCTF.md) | `docs/04-2.S_Health_2차리팩토링_체크리스트.md`, `Report/04-2.*` |
...
- **4-2:** 4단계 완료 후. 2단계와 동일 4항목(네이밍→하드코드·전역→추출→DRY), 범위는 4단계 신규·분리 코드.
- **5:** 코드 변경 없음. 1~4·4-2 산출물·diff 인용.
...
| 3-2 | `docs/03-2.S_Health_결함_레지스터.md`, `docs/03-2.S_Health_권장사항_레지스터.md`, `Report/03-2.S_Health_결함및권장사항_통합보고서.md` |
| 4 | `Report/04.S_Health_기능개선_보고서.md` |
| 4-2 | `docs/04-2.S_Health_2차리팩토링_체크리스트.md`, `Report/04-2.S_Health_2차리팩토링_보고서.md` |
